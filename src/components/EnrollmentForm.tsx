      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <div className="bg-yellow-50 p-4 rounded-lg mb-6 border-l-4 border-yellow-500">
            <div className="flex items-start">
              <svg className="w-6 h-6 text-yellow-600 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <ul className="text-yellow-800 space-y-1 ml-2 list-disc list-inside text-sm">
                  <li>The game will automatically enter <span className="font-semibold">full screen mode</span> when started.</li>
                  <li>You will be <span className="font-semibold">disqualified</span> if you exit full screen mode.</li>
                  <li>You will be <span className="font-semibold">disqualified</span> if you switch tabs more than 2 times.</li>
                  <li>Please ensure you're ready to play without interruptions.</li>
                </ul>
              </div>
            </div>
          </div>
